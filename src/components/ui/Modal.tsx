...
export function Modal({ isOpen, onClose, title, message, primaryAction, primaryText }: ModalProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: '#0f172a', fontWeight: 800, fontSize: '1.5rem', marginBottom: '1rem', letterSpacing: '-0.02em' }}>{title}</h2>
        <p style={{ color: '#475569', fontSize: '1.1rem', marginBottom: '2.5rem', lineHeight: 1.6 }}>{message}</p>
